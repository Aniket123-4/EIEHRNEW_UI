...
const ReceptionSearch = React.forwardRef((props) => {
    ...
    const items: TabsProps['items'] = [
        ...
        { key: '2', label: 'Allergic', children: '' },
        { key: '3', label: 'Battery Service', children: '' },
    ];

    const columns: ColumnsType<any> = [
        { title: 'Patient No', dataIndex: 'patientNo', key: 'patientNo', render: (text) => <a>{text}</a>, fixed: 'left' },
        {
            title: 'Name',
            dataIndex: 'candName',
            key: 'candName',
        ...
        { title: 'Case No', dataIndex: 'patientCaseNo', width: '20%', key: 'patientCaseNo' },
        { title: 'DOB', dataIndex: 'dob', key: 'dob' },
        { title: 'Age', dataIndex: 'age', key: 'age' },
        { title: 'Gender', dataIndex: 'genderName', key: 'genderName' },
        { title: 'Blood Group', dataIndex: 'bloodGroup', key: 'bloodGroup' },
        { title: 'Mobile No', dataIndex: 'curMobileNo', key: 'curMobileNo' },
        {
            title: 'Action',
            key: 'action',
            fixed: 'right',
    ...
    const getSectionList = async () => {
        const params = { "sectionID": -1, "userID": -1, "formID": -1, "type": 1 };
    ...
    const getDoctorList = async (value: any, item: any) => {
        const params = { "CommonID": item.value, "Type": 3 };
    ...
    const onChangeDateFilterMandatory = (e) => {
    ...
    const filterVisitForm = () => {
        return (
  <Card
    title={<span style={{ color: '#04010c', fontWeight: 600 }}>Filter & Search</span>}
    extra={
      <Space align="center" size="middle" wrap>
        {/* Right side: From/To Date + Checkbox */}
        <Form.Item name="fromToDate" style={{ marginBottom: 0,paddingTop:3 }}>
        ...
        <Checkbox 
          checked={isDateFilterMandatory} 
          onChange={onChangeDateFilterMandatory}
        >
  ...
  >
    ...
    >
               <Row gutter={16}>
            <Col span={5}>
                <Form.Item name="patientCaseNo" label="Patient Case No">
                    <Input />
                </Form.Item>
            </Col>
            <Col span={5}>
                <Form.Item name="patientNo" label="Patient No">
                    <Input />
                </Form.Item>
            </Col>
            <Col span={5}>
            ...
            <Col span={5}>
                <Form.Item name="patientUIDNo" label="Patient UID No">
                    <Input />
                </Form.Item>
            </Col>
            <Col span={4}>
                <Form.Item name="caseTypeID" label="Case Type">
                    <Select options={[{ value: -1, label: "All" }]} defaultValue={-1} />
                </Form.Item>
            </Col>
        </Row>
        ...
        <Row gutter={16}>
            ...
            <Col span={5}>
                <Form.Item name="sectionID" label="Specialization">
                    <Select showSearch options={sections} defaultActiveFirstOption={true} onChange={onPressSectionList} />
                </Form.Item>
            </Col>
            <Col span={5}>
                <Form.Item name="consultantDocID" label="Doctor">
                    <Select options={doctorList} defaultActiveFirstOption={true} />
                </Form.Item>
            </Col>
            <Col span={5}>
                <Form.Item name="patientFileNo" label="Patient File No" >
                    <InputNumber style={{ width: "100%",    height: "40px" }} min={0} />
                </Form.Item>
            </Col>
             <Col span={5}>
                <Form.Item name="patientMobile" label="Patient Mobile No">
                    <Input />
                </Form.Item>
            </Col>
            <Col span={4}>
                <Form.Item name="patientPhone" label="Patient Phone No">
                    <Input />
                </Form.Item>
            </Col>
            <Row gutter={16}>
        ...
        // return (
        //     <Card title={<span style={{ color: '#04010c', fontWeight: 600 }}>Filter & Search</span>} style={{ background:"#f0efc9de"}}>
        //         <Form
        //             form={filterForm}
        //             onFinish={onFinishPatForm}
        //             validateMessages={validateMessages}
        ...
        //                     </Form.Item>
        //                     <Checkbox checked={isDateFilterMandatory} onChange={onChangeDateFilterMandatory}>
        //                         Date filter required
        //                     </Checkbox>
        //                 </Col>
        //             </Row> */}
        ...
        //                 <Col span={5}>
        //                     <Form.Item name="patientFileNo" label="Patient File No">
        //                         <InputNumber style={{ width: "100%",    height: "46px;" }} min={0} />
        //                     </Form.Item>
        //                 </Col>
        //                  <Col span={5}>
        //                     <Form.Item name="patientMobile" label="Patient Mobile No">
        ...
        //                         Filter
        //                     </Button>
        //                     <Button onClick={handleResetFilter} type="default">
        //                         Clear
        //                     </Button>
        //                 </Space>
        //             </Form.Item>
    ...
    return (
        <>
            {/* Top: 4 Cards - Registration, New, Revisit, Checkout */}
            <div style={{ marginBottom: 24 }}>
                <Row gutter={16}>
                    <Col span={6} xs={24} xl={6}>
                        <Card bodyStyle={{ padding: 16 }} bordered={false} style={{ borderRadius: 12, boxShadow: '0 4px 12px rgba(0,0,0,0.06)' }}>
                            <Row align="middle">
                                <Col span={12}>
                                    <Title level={5} style={{ margin: 0 }}>Registration</Title>
                                </Col>
                                <Col span={12} style={{ textAlign: 'right' }}>
                                    <Title level={4} style={{ margin: 0, color: '#22c55e' }}>{patientDailyCount?.patReg || 0}</Title>
                                </Col>
                            </Row>
                        </Card>
                    </Col>
                    <Col span={6} xs={24} xl={6}>
                        <Card bodyStyle={{ padding: 16 }} bordered={false} style={{ borderRadius: 12, boxShadow: '0 4px 12px rgba(0,0,0,0.06)' }}>
                            <Row align="middle">
                                <Col span={12}>
                                    <Title level={5} style={{ margin: 0 }}>New</Title>
                                </Col>
                                <Col span={12} style={{ textAlign: 'right' }}>
                                    <Title level={4} style={{ margin: 0, color: '#22c55e' }}>{patientDailyCount?.patNewCase || 0}</Title>
                                </Col>
                            </Row>
                        </Card>
                    </Col>
                    <Col span={6} xs={24} xl={6}>
                        <Card bodyStyle={{ padding: 16 }} bordered={false} style={{ borderRadius: 12, boxShadow: '0 4px 12px rgba(0,0,0,0.06)' }}>
                            <Row align="middle">
                                <Col span={12}>
                                    <Title level={5} style={{ margin: 0 }}>Revisit</Title>
                                </Col>
                                <Col span={12} style={{ textAlign: 'right' }}>
                                    <Title level={4} style={{ margin: 0, color: '#22c55e' }}>{patientDailyCount?.patRevisit || 0}</Title>
                                </Col>
                            </Row>
                        </Card>
                    </Col>
                    <Col span={6} xs={24} xl={6}>
                        <Card bodyStyle={{ padding: 16 }} bordered={false} style={{ borderRadius: 12, boxShadow: '0 4px 12px rgba(0,0,0,0.06)' }}>
                            <Row align="middle">
                                <Col span={12}>
                                    <Title level={5} style={{ margin: 0 }}>Checkout</Title>
                                </Col>
                                <Col span={12} style={{ textAlign: 'right' }}>
                                    <Title level={4} style={{ margin: 0, color: '#22c55e' }}>{patientDailyCount?.patCheckOut || 0}</Title>
                                </Col>
                            </Row>
                        </Card>
                    </Col>
