...
import { requestAddCandidate, requestUpdateCandidate } from '../services/api';
...
console.log(selectedRows?.candidateID)
            const staticParams = {
            ...
            setLoading(true)
            const msg = await requestUpdateCandidate({ ...values, ...staticParams });
            setLoading(false)
    ...
    return (
        <>
            {/* <Drawer
                title={`${isEditable ? `Edit ${selectedRows?.firstName}` : ""}`}
                width={1000}
                onClose={closeDrawer}
                open={visible}
                            ...
                            >
                                <div style={contentStyle}>
                                    <Row gutter={16}>
                                        ...
                                        <Col span={8}>
                                            <Form.Item
                                            initialValue={selectedRows?.maritalStatusID}
                            ...
                            >
                                <div style={contentStyle}>
                                    <Row gutter={16}>
                                        ...
                                        <Col span={8}>
                                            <Form.Item
                                                initialValue={selectedRows?.branchID}
                                                name="branchID"
                                                label="branchID"
