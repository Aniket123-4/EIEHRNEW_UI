...
const Investigation = ({ patientDetails = {}, patientCaseID, onSaveSuccess, admNo }: any) => {
    const result6 = patientDetails?.result6 &&admNo ? patientDetails?.result6.filter((p:any) => p.admNo==admNo)
    ...
    const onFinishPatForm = async (values: any,isDelete:any=false) => {
        const params = {
            ...
            "col4": isDelete ? values?.admNo: "",
            "col5": isDelete ? values?.invSerialNo:"",
            "col6": values?.noOfInjection ? "" + values?.noOfInjection : "",
            "col7": values.invParameterID,//invArr,
            "col8": "",
            "col9": "",
            "col10": "",
            "col11": "",
        ...
        console.log(values,params, invArr)
        try {
            setLoading(true)
        ...
        <Space direction="vertical" size="small" style={{ display: 'flex' }}>
            ...
            <Row gutter={8}>
                <Col span={24}>
                    ...
                    <Table 
                    size='small' 
                    scroll={{ x: 1000,y:200 }} columns={columns} dataSource={result6} />
                    </div>
                </Col>
