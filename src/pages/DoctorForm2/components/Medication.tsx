...
const Medication = ({ patientDetails = {}, patientCaseID, onSaveSuccess, admNo, showForm, showTable }: any) => {
    const result5 = patientDetails?.result5 && admNo ? patientDetails?.result5.filter((p: any) => p.admNo == admNo)
        : patientDetails?.result5
    // console.log(patientDetails?.result5.filter(p => p.admNo==admNo))
        ...
        return (
            ...
            >
                ...
                <Row gutter={16}>
                    ...
                    <Col span={8}>
                        <Form.Item name="QtyTimesPerDay" label="No of Times Per Day" rules={[{ required: true }]}>
                            <InputNumber placeholder="Please Enter" style={{ width: "100%" }} min={0} />
                        </Form.Item>
                    </Col>
                    <Col span={8}>
