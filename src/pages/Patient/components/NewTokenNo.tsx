...
import { requestAddOnlinePatDoc, requestAddUpdatePatientDoc, requestFileUpload, requestGetPatientByTokenNo, requestGetPatientDoc, requestGetPatientHeader, requestGetTokenNoQueueJump, requestUpdatePatientTokenNo } from '../services/api';
                        ...
                        {patientTokenData?.patentTokenDetails && <>
                            ...
                            <Row style={{ padding: 5 }}>
                                {patientTokenData.patentTokenDetails.map((item: any) => {
                                    return (item.key == '2' ? <Col span={4}>
                                        <Button onClick={()=>getTokenNoQueueJump({tokenNo:item.children})} >{item.children}</Button>
                                    </Col>
                            ...
                            <Row>
                                ...
                                <Col span={12}>
                                    <Card
                                        ...
                                        title={'Token Status'}>
                                        <Table size='small' columns={columns} dataSource={statusData} pagination={false} />
                                    </Card>
                                </Col>
                            </Row>
                        </Card>
