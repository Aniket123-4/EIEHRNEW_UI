...
// plugins
export { Access, useAccess, useAccessMarkedRoutes } from 'D:/Projects/MSSPL/EIEHR_PROJECT/eiehrnew_ui/src/.umi/plugin-access';
export { addLocale, setLocale, getLocale, getIntl, useIntl, injectIntl, formatMessage, FormattedMessage, getAllLocales, FormattedDate, FormattedDateParts, FormattedDisplayName, FormattedHTMLMessage, FormattedList, FormattedNumber, FormattedNumberParts, FormattedPlural, FormattedRelativeTime, FormattedTime, FormattedTimeParts, IntlProvider, RawIntlProvider, SelectLang } from 'D:/Projects/MSSPL/EIEHR_PROJECT/eiehrnew_ui/src/.umi/plugin-locale';
export { Provider, useModel } from 'D:/Projects/MSSPL/EIEHR_PROJECT/eiehrnew_ui/src/.umi/plugin-model';
export { useRequest, UseRequestProvider, request, getRequestInstance } from 'D:/Projects/MSSPL/EIEHR_PROJECT/eiehrnew_ui/src/.umi/plugin-request';
// plugins types.d.ts
export * from 'D:/Projects/MSSPL/EIEHR_PROJECT/eiehrnew_ui/src/.umi/plugin-access/types.d';
export * from 'D:/Projects/MSSPL/EIEHR_PROJECT/eiehrnew_ui/src/.umi/plugin-antd/types.d';
export * from 'D:/Projects/MSSPL/EIEHR_PROJECT/eiehrnew_ui/src/.umi/plugin-layout/types.d';
export * from 'D:/Projects/MSSPL/EIEHR_PROJECT/eiehrnew_ui/src/.umi/plugin-request/types.d';
